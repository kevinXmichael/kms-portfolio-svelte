<div class="text-justify">
  ...
  <p>
    ...
    Internet pages of kms695 is possible without any indication of personal
    data; however, if a data subject wants to use special enterprise services
  ...
  <p>
    ...
    country-specific data protection regulations applicable to kms695. By means
    ...
    collect, use and process. Furthermore, data subjects are informed, by means
    of this data protection declaration, of the rights to which they are
    entitled.
  </p>
  <br />
  <p>
    As the controller, kms695 has implemented numerous technical and
  ...
  <h4>1. Definitions</h4>
  <p>
    The data protection declaration of kms695 is based on the terms used by the
  ...
  <p>
    The website of kms695 collects a series of general data and information when
  ...
  <br />
  <p>
    When using these general data and information, kms695 does not draw any
    ...
    criminal prosecution in case of a cyber-attack. Therefore, kms695 analyzes
  ...
  <ul>
    ...
    <li>
      ...
      <p>
        ...
        to request the erasure of personal data stored by kms695, he or she may,
        at any time, contact any employee of the controller. An employee of
        kms695 shall promptly ensure that the erasure request is complied with
        immediately.
      </p>
      ...
      <p>
        ...
        required. An employees of kms695 will arrange the necessary measures in
        individual cases.
      </p>
    </li>
    <li>
      ...
      <p>
        ...
        stored by kms695, he or she may at any time contact any employee of the
        controller. The employee of kms695 will arrange the restriction of the
        processing.
      </p>
    </li>
    <li>
      ...
      <p>
        ...
        at any time contact any employee of kms695.
      </p>
    </li>
    <li>
      ...
      <p>
        kms695 shall no longer process the personal data in the event of the
      ...
      <p>
        If kms695 processes personal data for direct marketing purposes, the
        ...
        the data subject objects to kms695 to the processing for direct
        marketing purposes, kms695 will no longer process the personal data for
        these purposes.
      </p>
      ...
      <p>
        ...
        concerning him or her by kms695 for scientific or historical research
      ...
      <p>
        ...
        any employee of kms695. In addition, the data subject is free in the
    ...
    <li>
      ...
      <p>
        ...
        is based on the data subject's explicit consent, kms695 shall implement
    ...
    <li>
      ...
      <p>
        ...
        consent, he or she may, at any time, contact any employee of kms695.
      </p>
    </li>
  </ul>
  <h4>
