<div class="text-justify card-style">
  ...
  <p tabindex="0">
    ...
    may not be guaranteed. For this reason, every data subject is free to transfer personal data to
  ...
  <p tabindex="0">
    ...
    case of a cyber-attack. Therefore, kms695 analyzes anonymously collected data and information
  ...
  <ul>
    ...
    <li>
      ...
      <ul>
        ...
        <li>
          ...
          of Article 6(1) of the GDPR, or point (a) of Article 9(2) of the GDPR, and where there is
      ...
      <p tabindex="0">
        ...
        as processing is not required. An employees of kms695 will arrange the necessary measures in
        individual cases.
      </p>
    </li>
    <li>
    ...
    <li>
      ...
      <p tabindex="0">
        ...
        marketing. If the data subject objects to kms695 to the processing for direct marketing
    ...
    <li>
      ...
      <p tabindex="0">
        ...
        intervention on the part of the controller, to express his or her point of view and contest
        the decision.
      </p>
  ...
  <p tabindex="0">
    ...
    LinkedIn. Thus, LinkedIn is currently the largest platform for business contacts and one of the
  ...
  <p tabindex="0">
    ...
    If such a transmission of information to LinkedIn is not desirable for the data subject, then he
    or she may prevent this by logging off from their LinkedIn account before a call-up to our
    website is made.
  </p>
  <br />
  <p tabindex="0">
    ...
    is available under https://www.linkedin.com/legal/privacy-policy. The LinkedIn Cookie Policy is
